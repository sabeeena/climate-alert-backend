...
public class AlertService {
    ...
    public AlertService(RestTemplate restTemplate, FireRTDataService fireRTDataService, BingLocationsService bingLocationsService) {
    ...
    public void alertRecipientsRealtime() throws JSONException, IOException {
        sendNotificationsToRecipients(getRecipientsFromAuthService());
    }
    ...
    private void sendNotificationsToRecipients(List<Map<String, Object>> recipients) throws IOException {
